...
/* In the Order_Details Table , calculate what percentage of the available order_ids have sum of 
total revenue (unit_price*quantity) more than 500? */

SELECT * FROM order_details, SUM unit_price * quantity AS totalrevenue;


/* In the Customers table, how many of the customers are in Germany and not an owner? */

SELECT * FROM customers, SUM();

/* 

What is the Employee_id for the youngest employee in the database?
...
/*In Orders table , how many orders were shipped to the cities starts with "a" and end in "e"?
